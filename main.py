...
if not os.path.isdir(f"/home/{USER}/.config/ducktheme"):
    ...
    os.system("sudo pacman -Syy hyprland wayland gtk3 xdg-desktop-portal-hyprland hyprlock hyprpaper hypridle hyprshot nautilus kitty rofi waybar hyprpolkitagent fastfetch fish --noconfirm")
